...
const consultationHref = computed(() => {
  ...
  const monthlyBundleId = props.product.productBundleIds?.monthly;



  console.log('monthlyBundleId', monthlyBundleId);
  console.log('props.product.productBundleIds', props.product.productBundleIds);
