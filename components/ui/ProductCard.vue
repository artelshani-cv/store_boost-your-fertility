<template>
  ...
  >
    <!-- Best Seller Flag -->
    <div v-if="isBestSeller" class="absolute top-3 left-3 z-10">
      <span
        class="text-black text-[12px] lg:text-[14px] rounded-full bg-[#FAFAFA] px-4 py-0.5 font-medium"
      >
        Best Seller
      </span>
    </div>
    ...
    <!-- Product Info Bar -->
    <div
      class="w-full h-6 md:h-[40px] text-[12px] flex justify-between items-center px-2 md:px-4 text-bodyColor"
    >
